...
Scott Nicholson, a Professor of Game Design and Development at Wilfrid Laurier University wrote a paper called _"Ask Why"._ In it he pleads for the consistency of escape games, based on knowledge from the video game industry. He raised this issue of conflict as well, and describes how the video game industry has had a similar debate. Narratologists, who argued that a games' primary focus is storytelling disagree with Ludologists, who focus on games as a set of mechanisms that invite play. Within the video games industry, the debate has moved focus to better integrate the two <Citation id="nicholson_2016_ask" />.

As a framework to do so, Nicholson <Citation id="nicholson_2016_ask" hideAuthor /> cites the concept of _Narrative Architecture_, which is commonly used by the theme park industry to create immersive experiences. Its goal is to embed game mechanisms (challenges, puzzles, etc.) in a larger world. Instead using a story as a shiny coat of paint, the story is woven into the space players explore. Within the realm of (escape) games, the narrative as such, will only progress as players clear challenges. Puzzles are the touch points with the story, and where they stick best in the players' mind.
...
On a scientific level, we find an explanation as to why escape rooms excel at sensory immersion. From the perspective of video games, Wirth et al. explain the formation of spatial presence (aka total immersion) as a two-step mental process <Citation id="wirth_2007_a" hideAuthor />. Simply put:
...
1. The first group is promised a reward for finishing a drawing — This group showed much less interest in drawing after receiving the reward, and their drawings were of lower quality too.
2. The second group was not promised or given a reward — They enjoyed the process of drawing and did not miss the reward. They are intrinsically motivated to finish the activity.
3. Some were given a surprise reward — They spent more time drawing than both of the previous two groups.
