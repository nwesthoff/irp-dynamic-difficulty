...
Sherlocked's upcoming experience illustrates this reality very well. Throughout the experience players have one end-goal, to perform a ritual. The figure below shows a stylised representation of the (preliminary) game flow. Their access to rooms is gradually rolled out, but many-a-times players will work on multiple puzzles at the same time.

[FIX FIGURE] <Citation id="" />
...
Designers combine the previously defined approaches to balance out the pros and cons of each. Sometimes they might chose to the experience of the individual over the team, and vice-versa. Other times they

Errol Elumir <Citation id="" hideAuthor />, looks at the compulsion loop from a different perspective. He describes it as a gameplay loop, and lists several activities an escape room player most likely will come across.
...
I personally feel that we should reconsider the terminology of the compulsion loop. The compulsion loop suggests that players only want to solve an escape room because of a reward, which is simply not true. For many, playing escape rooms is an intrinsically motivating experience. The overjustification effect demonstrates that the presence of a reward makes intrinsically motivating, we become less interested in the task after receiving the reward <Citation id="" />.
...
As Rachel Sugar explained, one goal of Escape Rooms is to provide an escape from reality. To be truly immersed in the world that is created and forget about everything outside <Citation id="sugar_2019_the" hideAuthor />.
