...
Most highly rated games are highly linear, but that doesn't mean there is no room for games that offer a challenge. But I also learned some enthusiasts do like solving challenging puzzles.
