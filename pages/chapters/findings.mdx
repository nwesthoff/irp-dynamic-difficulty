...
Mark Brown <Citation id="brown_2016_how" hideAuthor /> explains How Jonathan Blow designs puzzles. An especially interesting approach, since it has several results on the final interaction.
...
Escape rooms as a medium do well in some parts of immersion, but have much to improve in other areas. As Haley Cooper notes, the nature of escape rooms hinders the narrative immersion some other mediums do offer because spaces don't feel real. Furthermore, agency takes away control of pacing.

Some of these conflicts of interest have been resolved partially resolved though. There have certainly been attempts to bring them closer together. At Sherlocked they use several techniques to blur the lines between reality and fiction. From working with them I've noticed their narrative design is heavily inspired by real historical characters.
...
For Sherlocked, one of their primary goals designing new experiences is to have you guessing whether what just happened is real. At least for some people they seem to have succeeded. Victor told me he has hosted a group of players from Saudi Arabia that didn't want to continue, because they thought they were participating in a real heist.
...
> Instead they kind of shift every single puzzle. We'll just get slightly easier or slightly harder, but it still fits well within the narrative. Or they just go "actually, we're going to give you a little bit more narrative in this direction".
>
> - Eyal Danon <Citation id="" hideAuthor />

<PlayQuote url="/audio/eyal-danon-sentiment-analysis.mp3" />

> We've done a little bit of work with sentiment analysis with the Cogs system. [...] Which we then shelved entirely, because regardless of whatever language groups are speaking, different languages, you will never really get enough sample data in order to create a really good machine model for every single room.
>
> - Eyal Danon <Citation id="" hideAuthor />
