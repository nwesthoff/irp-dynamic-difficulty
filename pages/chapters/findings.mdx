...
> To talk about fairness. So I think there are three sides to difficulty. Which is physical difficulty, intellectual difficulty, and the difficulty of the unfamiliar. And I think you can only have, I only ever have a puzzle that tests people in one of three of these areas. And that's what for me, what I think helps construct a fair puzzle... in the context of a live experience.
>
> - Nick Moran <Citation id="moran_2021_panel" hideAuthor />
...
> Engagement is really the thing. Cause I think consistently what you will see is as people get frustrated, they start fussing with things or they just sit down for awhile. It's it's how engaged are they in continuing to solve? Um, and how many mistakes they make?
>
> - Ariel Rubin <Citation id="patel_2021_panel" hideAuthor />

Ariel also mentioned groups make mistakes more often when they are disengaged. When players disengage they usually start brute forcing puzzles, and lose interest in learning _how_ they should solve the puzzle. Which is troublesome when escape games want to implement Jonathan Blow's puzzle language philosophy. Being aware when that happens are important to consider for later interactions.

Eyal had a different answer to the same question.
